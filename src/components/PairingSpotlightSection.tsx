      ...
      <div className="relative z-10 grid gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="relative overflow-hidden rounded-[32px] bg-[#f8f1e7]/80 shadow-[0_35px_65px_-40px_rgba(72,47,30,0.6)]">
          <img
            ...
            src="https://public.youware.com/users-website-assets/prod/c8d83d64-ab08-43af-b839-829913645e37/fef074e893f14099b12418d89194ee47.jpg"
            loading="lazy"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#2f1b12]/45 via-transparent to-transparent" />
          <div className="absolute bottom-6 left-6 right-6 rounded-3xl bg-[#f7efe3]/85 p-6 backdrop-blur">
            <p className="text-xs uppercase tracking-[0.35em] text-[#9c7a58]">Ritual guiado</p>
